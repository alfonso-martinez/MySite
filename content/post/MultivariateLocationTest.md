...
\end{align}
where $\overline{\mathbf{X}} = \mathbf{1}^{\top}\mathbf{X}$ and $\mathbf{1}$ is a $n \times 1$ vector of 1's, follows a $\chi^2$ distribution with $p$ degrees of freedom (denoted $\chi^2_p$). 
